...
- It was simple to boot up a Node app and get "Hello, world" running. Complications arose once controllers started to get a bit more complicated as I learned that Node runs asynchronously. I can see why it would be incredibly power to some. For an app this small, and this being my first time working in Node, it was a difficult learning experience. 
